...
export default function HomePage() {
  ...
  {
    /* Passing user obj to child components */
  }
  ...
  return (
    <div className="#home-page min-h-screen h-auto flex flex-col items-center w-full bg-[var(--homepage-bg)] overflow-hidden">
      <div className="#header w-full flex items-center justify-end min-h-20 p-1 bg-[var(--homepage-header-bg)]">
        {userLoading ? (
          <p className="text-white sm:mr-20">Loading...</p>
        ) : user ? (
      ...
      <div className="#body flex flex-grow flex-col justify-center items-center h-full w-full px-5 sm:px-0">
        <div className="flex flex-col p-1 sm:flex-row items-start sm:items-center w-full px-1 sm:px-3 sm:py-2 gap-2 max-w-[570px] bg-[var(--homepage-body-input-bg)] rounded-md">
          <CustomInput onValueChange={handleYTLink} />
          ...
          <div className="w-full sm:w-auto flex items-center gap-2">
            ...
            <AnimatingButton
              ...
              defaultText="Convert"
              setButtonState={() => ConvertToMP3(youtubeLinkRef, animatingButtonTackerID)}
            />
          </div>
        </div>
