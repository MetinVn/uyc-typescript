...
export const MusicCard = memo(
  ({ music, onRate, onToggleFavorite, onRemove }: IMusicCard) => {
      ...
      >
        ...
        <div className="flex items-center mt-1">
          ...
          <div ref={cardRef} className="flex relative">
            ...
            <div
              className={`py-2 absolute overflow-hidden right-3 -top-[90px] w-32 min-w-[140px] z-50 bg-[var(--gray-800)] rounded-md shadow-lg flex flex-col text-xs text-left text-[var(--gray-100)] transform duration-200 ease-in-out ${
                isMenuOpen
                  ? "opacity-100 visible scale-100"
                  : "opacity-0 invisible scale-80 pointer-events-none"
              }`}
            >
              <button
                type="button"
