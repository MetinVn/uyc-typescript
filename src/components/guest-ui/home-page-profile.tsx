...
export const GuestProfile = () => {
  ...
  return (
    <div ref={dropdownRef} className="relative w-fit sm:mr-20">
      ...
      <button
        onClick={handleToggle}
        className="sm:hidden flex items-end p-1 rounded-full cursor-pointer bg-[var(--homepage-profile-guest-bg)] active:bg-[var(--homepage-profile-bg-active)] transition"
      >
      ...
      <div
        ...
        } absolute right-1/2 translate-x-4 sm:translate-x-1/2 top-full min-w-55 w-full p-4 rounded-xl z-20 transition-all bg-[var(--homepage-profile-dropdown-bg)]`}
      >
        <div className="flex flex-col gap-1 text-[var(--homepage-profile-dropdown-text)]">
          {/* Welcome section */}
